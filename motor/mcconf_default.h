...
#endif
// SynRM MTPA lookup table id*(|I|) in CENTIamps (0.01 A units — keeps |id*| up to ~328 A inside
// int16), 33 pts on a uniform |I| axis 0..MTPA_LUT_IMAX. Default generated by
...
#define MCCONF_FOC_MTPA_LUT				{0, -33, -116, -224, -342, -468, -602, -741, -884, -1032, -1186, -1344, -1525, -1689, -1857, -2031, -2184, -2344, -2500, -2683, -2986, -3201, -3406, -3622, -3838, -4046, -4248, -4449, -4643, -4837, -5048, -5333, -5598}
#endif
#ifndef MCCONF_FOC_MTPA_LUT_IMAX
#define MCCONF_FOC_MTPA_LUT_IMAX		70.0	// current magnitude (A) at the last LUT sample
#endif
