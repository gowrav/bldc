...
#endif
// SynRM MTPA lookup table id*(|I|) in AMPS (float32 — supports the full +-450 A controller range,
// no scale/overflow), 33 pts on a uniform |I| axis 0..MTPA_LUT_IMAX. Default generated by
// docs/synrm/tools/mtpa_from_maps.py from the MotorXP FEA dq flux maps (9kW PMa-SynRM, p=2).
// Uploadable/editable from vesc_tool (3.2b); this is the seed value.
#ifndef MCCONF_FOC_MTPA_LUT
#define MCCONF_FOC_MTPA_LUT				{0.0000f, -0.4556f, -1.4893f, -2.7829f, -4.1903f, -5.7289f, -7.3337f, -8.9788f, -10.7155f, -12.5108f, -14.4854f, -16.4580f, -18.3457f, -20.3706f, -22.1752f, -23.9951f, -25.8876f, -28.7735f, -31.6676f, -34.0332f, -36.5313f, -39.0086f, -41.3895f, -43.7082f, -45.9976f, -48.2332f, -50.6691f, -53.9961f, -56.7763f, -59.3077f, -61.8870f, -64.1392f, -65.4520f}
#endif
